                                    ...
                                    order.length === 0 ? (
                                        ...
                                        order.map((item, index) => (
                                            <tr key={index} className="border-b">
                                                ...
                                                <td className="p-1">{item.jadwal.master_rute.kota_asal} - {item.jadwal.master_rute.kota_tujuan}</td>
                                                <td className="p-1 ps-4">{item.jadwal.waktu_keberangkatan}</td>
                                                ...
                                                <td className="p-1">
                                                    ...
                                                    {item.status === 'Sukses' ? (
                                                        ...
                                                        <span className="bg-gray-300 text-gray-600 py-1 px-3 rounded text-xs">Menunggu</span>
                                                    )}
                                                </td>
                                                <td className="p-3">
                                                    <button>
