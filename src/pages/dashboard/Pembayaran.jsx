    ...
    return (
        <>
            ...
            <div className="my-5">
                ...
                <div className="my-4">
                    <PaymentItemComponent title={"e-Money"} icon={
                        <PiMoney className='text-softBlue' size={24} />
                    } />
                </div>
                <div className="my-4">
                    <PaymentItemComponent title={"Virtual Account"} icon={
                        <IoMdPhonePortrait className='text-softBlue' size={24} />
                    } />
                </div>
                <div className="my-4">
                    <PaymentItemComponent title={"Bank Transfer"} icon={
                        <AiOutlineBank className='text-softBlue' size={24} />
                    } />
                </div>
                <div className="my-4">
                    <PaymentItemComponent title={"Credit Card"} icon={
                        <PiCreditCard className='text-softBlue' size={24} />
                    } />
                </div>
                <div className="my-4">
                    <PaymentItemComponent title={"Cash"} icon={
                        <img src={Money} />
                    } />
                </div>
            </div>
